...
//                 debugPrint(" All User IDs for statuses: $allUserIds ");
...
//                   builder: (context, snap) {
//                     debugPrint(
//                       "Fetched status docs: ${snap.data?.docs.length}",
//                     );
...
//                                 GestureDetector(
//                                   onTap: () async {
//                                     final hasStatus = await _statusService
//                                         .userHasStatus(currentUserId);
//                                     if (hasStatus) {
//                                       Navigator.push(
//                                         context,
...
//                                     MaterialPageRoute(
//                                       builder: (_) =>
//                                           MyStatusViewScreen(userId: userId),
//                                     ),
//                                   );
//                                 },
...
//                               SizedBox(height: mq.height * .01),
//                               Text(
//                                 userId == currentUserId ? "You" : "Friend",
          ...
          SizedBox(
            ...
            child: FutureBuilder<List<String>>(
              ...
              builder: (context, friendsSnap) {
                ...
                final allUserIds = [...friendIds, currentUserId];
                ...
                return StreamBuilder(
                  ...
                  builder: (context, snap) {
                    ...
                    /// Filter only current user + friends
